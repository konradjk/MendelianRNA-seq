...
#This section performs hiearchichal clustering to output text saying whether your sample clusters closely with muscle. It's just another a way to look at the data. 

#For this you need to specify the number of clusters you expect based on the GTEx data. 
#With skin-lower leg, skin-subprapubic, skeletal-muscle, adipose-subcutaneous and fibroblasts we expect 5
nClus = 5
